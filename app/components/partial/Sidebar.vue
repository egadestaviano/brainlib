  ...
  <aside @mouseenter="sidebar.hovered = true" @mouseleave="sidebar.hovered = false" :class="[
    ...
    <div class="px-7 flex-1 flex flex-col overflow-hidden">
      <button @click="sidebar.toggleClassList" :class="[
        'w-full flex items-center gap-2 p-2 rounded-lg hover:bg-slate-50 transition cursor-pointer',
        ...
        <div v-if="sidebar.classListOpen && (!sidebar.collapsed || sidebar.hovered)"
          ...
          <div class="h-full overflow-y-auto">
            <div class="space-y-3 py-1">
              <NuxtLink v-for="cls in classesWithColor" :key="cls.id" :to="`/classes/${cls.id}`"
